        ...
        <div className="py-12 sm:py-14 lg:py-16 2xl:py-20 relative z-10">
          <div className="flex flex-col md:flex-row gap-5 md:gap-0 relative sm:bg-[#F7FAFF] lg:bg-transparent sm:px-5 sm:py-6">
            <Image
              ...
              alt="A representation of Qrinux's services"
              className="md:w-2/5 h-[500px] object-cover"
            />
            <article className="md:w-3/5 lg:w-2/3 lg:py-10 lg:p-10 lg:absolute top-0 bottom-0 lg:m-10 left-1/4 bg-[#F7FAFF] px-5 py-10 sm:pl-5 sm:px-0 sm:py-0">
              ...
              <Description>
                <span className="text-[#163359]">
                  ...
                  stunning, user-friendly websites, apps, and digital solutions
                  that connect businesses with their audiences. By combining
                  creativity, technology, and precision, we ensure each project
                  aligns with your goals and resonates with your target market.
                  From sleek websites and dynamic apps to comprehensive digital
                  strategies, Qrinux delivers exceptional results and service.
                </span>
              </Description>
            </article>
          </div>
