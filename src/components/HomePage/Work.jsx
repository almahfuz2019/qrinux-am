...
const Work = ({ work }) => {
  ...
  // Limit the description length and add ellipsis
  const maxLength = 110;
  ...
  return (
    <article className="bg-[#FBFFF1] lg:flex px-5 pt-5 sm:px-10 sm:pt-10 w-full gap-10">
      <div className="lg:w-2/5">
        <Heading>
          <span className="text-primary">{title}</span>
        </Heading>
        <Description>
          <span className="text-[#152847]">{truncatedDescription}</span>
        </Description>
        <Link
          key={slug}
          href={`/project/${slug}`}
      ...
      <div className="lg:w-3/5 relative overflow-hidden h-60 sm:h-96">
        <Image
          ...
          width={346}
          src={img9}
          alt={`Screenshot of ${title} - Image 1`}
        ...
        <Image
          ...
          width={346}
          src={img10}
          alt={`Screenshot of ${title} - Image 2`}
        ...
        <Image
          ...
          width={346}
          src={img11}
          alt={`Screenshot of ${title} - Image 3`}
